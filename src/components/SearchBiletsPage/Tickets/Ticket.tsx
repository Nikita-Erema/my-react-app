	...
	return (
		<div className="ticket">
			<div className="ticket-number-train">
				...
				<p className="ticket-number-train-text">{number}</p>
				<p className="ticket-number-train-town">{fromWhere} →</p>
				<p className="ticket-number-train-town">{whereTo}</p>
			</div>
			<div className="ticket-direction-box">
				<TicketDiection
					fromWhere={fromWhere}
					whereTo={whereTo}
